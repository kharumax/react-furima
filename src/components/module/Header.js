...
const Header = (props) => {
    ...
    const renderUserProfileImage = () => {
        if (isLogin && user.profile_image != null && user.profile_image !== "") {
            return (
    ...
    const renderUserProfileInfo = () => {
        if (isLogin) {
            return (
                <>
                    <IconButton aria-label="logout-link" color="inherit">
                        <Button variant={"contained"} color={"secondary"} style={{cursor: "pointer"}} onClick={Logout}>
                            ログアウト
                        </Button>
                    </IconButton>
                    <IconButton aria-label="current-user-username" color="inherit">
        ...
        return (
            <>
                ...
                <IconButton aria-label="login-link" color="inherit">
